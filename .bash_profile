...
alias ping-pi='ping raspberrypi.local'
	# ping raspberrypi when on local network
...
## 1. Generate new key
##
##	> $ ssh-keygen -t rsa -b 4096 -C "monirondon15@gmail.com"
##
...
##	 & store passphrases in keygen (OSX >= 10.12.2)
##
##	> Host *
##	> 	AddKeysToAgent yes
##	>	UseKeychain yes
...
##	>
##
## 4. Copy key and add to GitHub account
##
##	> $ pbcopy < ~/.ssh/id_rsa.pub
##

alias gen-ssh-key='ssh-keygen -t rsa -b 4096 -C "monirondon15@gmail.com"'
